    ...
    <table class="table-boleto" cellpadding="0" cellspacing="0" border="0">
        ...
        <tr>
            ...
            <td>
                ...
                <div class="conteudo rtl"><?php echo $pagador['documento']; ?></div>
            </td>
        </tr>
        <tr>
            <td width="130">
                <div class="titulo">Nosso Número</div>
                <div class="conteudo"><?php echo $nosso_numero_boleto; ?></div>
            </td>
            <td width="130">
            ...
            <td colspan="2">
                ...
                <div class="conteudo"><?php echo $agencia_codigo_beneficiario; ?></div>
            </td>
        ...
        <tr>
            <td colspan="4">
                ...
                <div class="conteudo"><?php echo $beneficiario['endereco']; ?> | <?php echo $beneficiario['endereco2']; ?></div>
            </td>
            <td width="130">
